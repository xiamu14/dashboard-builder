...
const LayersLight = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill={props.color || "#6F767E"} fillRule="evenodd">
      <path d="M12.025 2.187a3 3 0 0 0-2.05 0L2.926 4.75l7.049 2.563a3 3 0 0 0 2.05 0l7.049-2.563-7.049-2.563ZM9.291.307a5 5 0 0 1 3.418 0l7.048 2.563c1.756.639 1.756 3.121 0 3.76L12.71 9.193a5 5 0 0 1-3.418 0L2.243 6.63c-1.756-.639-1.756-3.121 0-3.76L9.29.307Z" />
